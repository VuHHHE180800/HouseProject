                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="">
                                        <div class="d-flex add" role="search">
                                            <a href="addhome.jsp"><i style="color: white;" class="fa-solid fa-plus"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </nav>
                        <div class="card mb-4">
                            <c:forEach items="${sessionScope.listH}" var="o" >
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-3 d-flex justify-content-center">
                <div>
                  ...
                  <p class="lead fw-normal mb-0">${o.name}</p>
                </div>
              </div>

              <div class="col-md-3 d-flex justify-content-center">
                <div>
                  <p class="small text-muted mb-4 pb-2">Địa chỉ</p>
                  <p class="lead fw-normal mb-0">${o.address}</p>
                </div>
              </div>
              ...
              <div class="col-md-3 d-flex justify-content-center">
                <div>
                  ...
                  <div class="edit">
                        <a href="edithome?homeID=${o.home_id}"><i style="color: black;" class="fa-solid fa-pen"></i></a>
                                            
                        </div>
                    <div class="view">
                            <a  href="shoproom?homeID=${o.home_id}"><i style="color: white;" class="fa-solid fa-eye"></i></a>     
                        </div>
                        <div class="remove">
                            <a onclick="return confirm('Do you want to delete this home')" href="removehome?homeID=${o.home_id}"><i style="color: white;" class="fa-solid fa-trash-can"></i></a>     
                        </div>
                            ...
                            <c:if test="${sessionScope.n==0}">
                                <div class="card-body p-4">
                                    ...
                                    <a class="nav-link "  href="changetobuy" >Buy</a>
                                </button>
