                    ...
                    <div class="card bg-light mb-3" style="margin-top: 10px">
                            ...
                            <div class="row g-0 criteria">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body content">
                                        <p class="card-text"><small class="text-body-secondary">Tổng số phòng:</small></p>
                                        <h5 class="card-title">${sessionScope.c1}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="row g-0 criteria">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body content">
                                        <p class="card-text"><small class="text-body-secondary">Doanh thu:</small></p>
                                        <h5 class="card-title">${sessionScope.c4}vnđ</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row list2">
                        ...
                        <div class="col-md-4">
                            <div class="row g-0 criteria">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body content">
                                        <p class="card-text"><small class="text-body-secondary">Số phòng trống:</small></p>
                                        <h5 class="card-title">${sessionScope.c2}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="row g-0 criteria">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body content">
                                        <p class="card-text"><small class="text-body-secondary">Số khách trọ:</small></p>
                                        <h5 class="card-title">${sessionScope.c3}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
