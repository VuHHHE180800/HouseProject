        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="container" style="margin-top: 10px">
                <div class="row">  
                    ...
                    <div class="container products" style="width: 1020px;height: auto">
                        <div >
                            <nav class="navbar navbar-expand-lg bg-body-tertiary" style="width: 990px;height: 96px">
                                <div class="container-fluid">
                                    <h5 class="navbar-brand" href="#">Hợp đồng</h5>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Tổng tiền đặt cọc</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${i.username}</td>
                                    <td>${i.room_name}</td>
                                    <td>${i.timeRent} tháng</td>
                                    
                                    <td>${i.bookingDate}</td>
                                    <td>${i.enterDate}</td>
                                    <td>${i.totalPrice}vnđ</td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <th scope="row" style="color: green;">${sessionScope.totalSales}vnđ</th>
                                </tr>
