        ...
        <div class="container">
            <main>
                ...
                <div class="row g-5" style="justify-content: center;">
                    ...
                    <div class="col-md-8">
                        <form class="needs-validation" action="addroom"  enctype="multipart/form-data">
                            <div class="row g-3">
                                

                                <div class="col-12">
                                    <label for="rname" class="form-label">Phòng</label>
                                    <input name="rname" type="text" class="form-control" id="rname" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input name="rprice" type="number" class="form-control" id="rprice" required>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input name="nhuman" type="text" class="form-control" id="nhuman" required>
                                </div>

                                <div class="col-sm-6">
                                    <label for="dt" class="form-label">Diện tích</label>
                                    <input name="dt" type="text" class="form-control" id="dt" required>
                                </div>
